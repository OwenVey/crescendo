...
const Select = ({ placeholder, label, children, className }: SelectProps) => {
  return (
    <SelectPrimitive.Root>
      <SelectTrigger
        className={cn(
          'w-full text-gray-900 data-[placeholder]:text-gray-900 dark:text-gray-50 dark:data-[placeholder]:text-gray-50',
          className,
        )}
      >
