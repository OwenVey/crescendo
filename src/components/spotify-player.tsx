    ...
    <AnimatePresence>
      {player && currentTrack && (
        <motion.div
          ...
          className="absolute bottom-0 z-50 flex h-auto w-full flex-shrink-0 items-center justify-center border-t border-gray-200 bg-white px-2 py-2 shadow-sm-up dark:border-gray-800 dark:bg-gray-950 md:h-16 md:py-0"
        >
          <div className="flex w-full items-center justify-between md:grid md:grid-cols-3">
            ...
            <div className="mr-24 hidden items-center justify-end gap-1 md:flex">
              ...
              <Button
                ...
                variant="ghost"
                size="icon"
                tooltip={isCurrentTrackSaved ? 'Unlike track' : 'Like track'}
              >
                <HeartIcon className="h-5 w-5" fill={isCurrentTrackSaved ? 'currentColor' : 'none'} />
              </Button>

              <Button onClick={toggleMute} variant="ghost" size="icon" tooltip="Toggle Mute">
                {getVolumeIcon()}
              </Button>
